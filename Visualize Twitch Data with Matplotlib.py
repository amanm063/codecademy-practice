...
#link to the github is https://github.com/sonnynomnom/Codecademy-Learn-SQL-from-Scratch/tree/master/Twitch
...
plt.title("viewers of different games")
ax=plt.subplot()
...
plt.plot(hour,viewers_hour,label = "viewers")
y_upper = [i + (i*1.5) for i in viewers_hour]
y_lower = [i - (i*1.5) for i in viewers_hour]
